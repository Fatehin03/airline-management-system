    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="relative">
        ...
        <div className="relative h-[80vh] w-full flex items-center justify-center overflow-hidden">
          ...
          {/* Hero Content */}
          <div className="relative z-20 w-full max-w-7xl mx-auto px-6 text-center text-white animate-fadeInUp">
        ...
        {/* FEATURES SECTION - Adjusted Positioning */}
        <div className="relative z-30 -mt-12 md:-mt-16 pb-12">
...
const FeatureCard = ({ icon, title, desc }) => (
  <div className="bg-white p-8 rounded-2xl shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center text-center transition-all duration-300 hover:shadow-2xl hover:border-blue-200">
    <div className="text-blue-600 mb-5 p-4 bg-blue-50 rounded-2xl animate-float">
      {icon}
    </div>
